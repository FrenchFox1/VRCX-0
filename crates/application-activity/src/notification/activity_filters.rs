...
) -> Result<OverlayActivityPreferenceFilters> {
    filters.version = 1;
...
) -> Result<OverlayActivityFilterProfile> {
...
pub fn load_overlay_activity_filters(config: &dyn NotificationConfig) -> OverlayActivityFilters {
